...
#path = os.curdir()
#databunch = ImageList(train,"E:\my programs\python\App\data").split_none().transform(tfms).databunch(d)
data_bunch = ImageDataBunch.single_from_classes(r'C:\Users\HP\Desktop\sgp4\app',classes,ds_tfms=get_transforms(), size=256).normalize(imagenet_stats)
